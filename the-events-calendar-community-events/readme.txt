...
* PHP 7.3 or greater (recommended: PHP 7.4 or greater)
* WordPress 5.8.4 or above
* jQuery 3.x.x
* The Events Calendar 6.0 or above

== Documentation ==

Community Events extends the functionality of The Events Calendar (https://evnt.is/3j) to allow for frontend event submission on your WordPress site. With pretty permalinks enabled, the frontend fields are accessible at the following URLs:
...
But wait: there's more! We've got a whole stable of plugins available to help you be awesome at what you do. Check out a full list of the products below, and over at the <a href="https://evnt.is/3k">The Events Calendar website.</a>
